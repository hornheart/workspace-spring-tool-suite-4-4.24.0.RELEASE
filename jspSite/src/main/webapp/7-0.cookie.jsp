	...
	<table width="80%" border="0" cellspacing="0" cellpadding="2"
		...
		<tr>
			...
			<br> <font color="#0000FF"> HTTP 프로토콜은 브라우저에서 요청이 있을 때 마다
					새로운 네트워크 연결이 이루어지기 때문에<br> 사용자의 요청에 네트워크 연결이 지속되지 않으므로 클라이언트의
					요청을 서로 구분 할수 없으며,<br> 클라이언트의 상태정보를 저장 할 수 없다.
			</font><br>
			<br> 상태가 없으면 웹을 이용한 응용프로그램(대표적으로 쇼핑몰 구현)을 개발하기 어려워 지는데,<br>
				이것은 사용자가 쇼핑몰을 방문해서 원하는 상품을 선택할 때마다 이전에 선택한 상품정보는<br> 잃어버리는 문제가
				발생하기 때문이다.<br>
			<br> <font color="#FF00FF"> 이런한 문제를 해결(상태정보 유지)하기 위해서 쿠키와
					세션이 등장하게 되었다.</font> <br>
			<br></td>
		</tr>
