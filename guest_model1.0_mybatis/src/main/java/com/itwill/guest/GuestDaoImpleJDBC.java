 ...
 *     단위메쏘드를 가지고있는 객체(클래스)
 */
public class GuestDaoImpleJDBC implements GuestDao {
	/*
	 * - DataSource객체 : Connection을 반환해주는객체
	 * - 톰캣에서제공하는 DataSource 객체사용
	 */
	private DataSource dataSource;
	public GuestDaoImpleJDBC() throws Exception{
		...
		properties.load(GuestDaoImpleJDBC.class.getResourceAsStream("/jdbc.properties"));
