...
public class StudentDaoMapperInterface {
	...
	public Student findStudentByIdWithAddress(Integer studId) {
		SqlSession sqlSession = sqlSessionFactory.openSession(true);
		Student student = sqlSession.getMapper(StudentMapper.class).findStudentByIdWithAddress(studId);
		sqlSession.close();
		return student;
	}
	...
	public Student findStudentByIdWithCourses(Integer studId) {
		SqlSession sqlSession = sqlSessionFactory.openSession(true);
		Student student = sqlSession.getMapper(StudentMapper.class).findStudentByIdWithCourses(studId);
		sqlSession.close();
		return student;
	}
	...
	public int insertStudentBySequenceReturnPrimaryKey(Student student) {
		SqlSession sqlSession = sqlSessionFactory.openSession(true);
		int rowCount =sqlSession.getMapper(StudentMapper.class).insertStudentBySequenceReturnPrimaryKey(student);
		sqlSession.close();
	...
	public int updateStudentById(Student updateStudent) {
		SqlSession sqlSession = sqlSessionFactory.openSession(true);
		int rowCount = sqlSession.getMapper(StudentMapper.class).updateStudentById(updateStudent);
		sqlSession.close();
		return rowCount;
	}
	...
	public int deleteStudentById(Integer studId) {
		SqlSession sqlSession = sqlSessionFactory.openSession(true);
		int rowCount = sqlSession.getMapper(StudentMapper.class).deleteStudentById(studId);
		return rowCount;
	}
