...
public class AddressDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Address address= addressService.addressDetail(Integer.parseInt(noStr));//pk
			...
			out.printf("	<a href='address_delete_action?no=%d'>%s님 삭제[GET]</a>",address.getNo(),address.getName());
