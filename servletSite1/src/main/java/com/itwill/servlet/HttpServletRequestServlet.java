...
public class HttpServletRequestServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		<< query string >> 
		  ...
		  1.GET  요청방식 : request?name=kim&phone=1234&address=seoul
		    
		    - 클라이언트요청URL : http://192.168.15.31/servletSite/request?name=kim&phone=1234&address=seoul
		    
                	            -----------------------------------------------------------------
             		요청라인    |GET /servletSite/request?name=kim&phone=1234&address=kyunggi HTTP/1.1       |
		  ...
		  2.POST 요청방식 : request  
		    ...
		    - 클라이언트요청URL : http://192.168.15.31/servletSite/request

                	            -----------------------------------------------------------------
             		요청라인    |POST /servletSite/request HTTP/1.1                             |
             		요청헤더    |HOST:192.168.15.31                                             |
             		.......     |...                                                            |
                	            |---------------------------------------------------------------|
