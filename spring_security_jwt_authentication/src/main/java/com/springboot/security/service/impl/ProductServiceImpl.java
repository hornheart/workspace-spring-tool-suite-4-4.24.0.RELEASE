...
public class ProductServiceImpl implements ProductService {
	...
	public List<ProductDto> getProductList() {
		...
		LOGGER.info("[getProductList] found ProductList :: size : {}", productEntityList.size());
	...
	public ProductDto changeProduct(ProductDto productDto) {
		...
		if (productRepository.findById(productDto.getNumber()).isEmpty())
			return null;
		
		Product foundProductEntity = productRepository.findById(productDto.getNumber()).get();
        System.out.println(">>>>>>>>>>>>>>"+foundProductEntity);
		LOGGER.info("[changeProduct] found Product's name : {}", foundProductEntity.getName());
		foundProductEntity.setName(productDto.getName());
		foundProductEntity.setPrice(productDto.getPrice());
		foundProductEntity.setStock(productDto.getStock());
