...
public class GuestService{
		public final static int GUEST_SEARCH_BY_ALL=0;
		public final static int GUEST_SEARCH_BY_NAME=1;
		public final static int GUEST_SEARCH_BY_TITLE=2;
		public final static int GUEST_SEARCH_BY_CONTENT=3;
