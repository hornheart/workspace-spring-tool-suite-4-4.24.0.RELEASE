...
public class UserRestController {
	...
	@LoginCheck
	@PutMapping("/{userId}")
	public ResponseEntity<Response> user_modify_action(@PathVariable("userId") String userId, @RequestBody User user)throws Exception{
	...
	@LoginCheck
	@GetMapping("/login")
	public ResponseEntity<Response> user_login_check(@SessionAttribute(name="sUserId", required = false)@Parameter(hidden = true) String sUserId)
			throws Exception{
